...
import time,random,sys,os,useragent,urllib
reload(sys)
...
for index,wd in enumerate(wds,1):
        ...
        driver=webdriver.PhantomJS(executable_path="usr\phantomjs\\bin\phantomjs.exe")  #调用chrome浏览器
        #driver.set_window_position(20, 40)

        driver.maximize_window()
        driver.get('http://tools.aizhan.com/api/ret/?sheng=none&shi=none&shou=baidu&ci=%s&yu=www.19888.tv&id=&t=0'%urllib.quote(wd))
        #elem = driver.find_element_by_id("kw_baidu")
